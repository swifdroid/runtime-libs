...
2. Use `ARCH_INDEX.md` to choose the primary owner.
3. Read `SOURCE_MAP.md` before broad discovery.
4. Inspect the exact root/module Gradle files, script, binary paths, changelog entries, or consumer rules involved.
5. Add a sibling repository only for a concrete downstream compatibility question.
6. Stop loading once ownership, scope, and required evidence are clear.
