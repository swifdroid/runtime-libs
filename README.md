...
```kotlin
dependencies {
    implementation("com.github.SwifDroid.runtime-libs:core:6.3.0")
    implementation("com.github.SwifDroid.runtime-libs:foundation:6.3.0")
    implementation("com.github.SwifDroid.runtime-libs:foundationessentials:6.3.0")
    implementation("com.github.SwifDroid.runtime-libs:i18n:6.3.0")
    implementation("com.github.SwifDroid.runtime-libs:networking:6.3.0")
    implementation("com.github.SwifDroid.runtime-libs:testing:6.3.0")
    implementation("com.github.SwifDroid.runtime-libs:xml:6.3.0")
}
```
...
./copy-so-files.sh https://download.swift.org/swift-6.3-release/android-sdk/swift-6.3-RELEASE/swift-6.3-RELEASE_android.artifactbundle.tar.gz
...
./copy-so-files.sh --dry swift-6.3-RELEASE_android.artifactbundle.tar.gz

# Use an already-extracted artifact bundle directory
./copy-so-files.sh ./swift-6.3-RELEASE_android.artifactbundle
```
